...
3.  **Data Structure Design** (Pattern 26)
4.  **Tree DFS (Pre/In/Post)** (Pattern 10)
5.  **Tree BFS (Level Order)** (Pattern 11)
6.  **Binary Search Tree Properties** (Pattern 24)
...
7.  **BFS with State (0-1 BFS)** (Pattern 34)
8.  **Shortest Path (Dijkstra/Bellman)** (Pattern 35)
9.  **Floyd-Warshall** (Pattern 44)
10. **Minimum Spanning Tree** (Pattern 45)
11. **Strongly Connected Components** (Pattern 47)
...
5.  **Trie** (Pattern 20)
6.  **Divide and Conquer** (Pattern 50)
7.  **Meet-in-the-Middle** (Pattern 29)
8.  **Non-Comparison Sorting** (Pattern 49)
9.  **Randomized Algorithms** (Pattern 42)

### 🗓️ Phase 5: Dynamic Programming (Week 6)
*Goal: Solve complex overlapping subproblems.*
1.  **DP (1D)** (Pattern 15)
2.  **DP (2D)** (Pattern 16)
3.  **DP on Trees** (Pattern 32)
4.  **DP on Graphs** (Pattern 33)
5.  **State Compression DP** (Pattern 30)
6.  **Digit DP** (Pattern 31)

### 🗓️ Phase 6: Specialist & Advanced (Bonus)
*Goal: Crack L5+ / Hard Interviews.*
*   **Bit Manipulation** (Pattern 19)
*   **Segment Tree** (Pattern 36)
*   **Fenwick Tree** (Pattern 37)
*   **Monotonics & Line Sweep** (Patterns 27, 28)
*   **Mo's Algorithm** (Pattern 38)
*   **Rolling Hash** (Pattern 39)
*   **KMP Algorithm** (Pattern 40)
*   **Z-Algorithm** (Pattern 41)
*   **Reservoir Sampling** (Pattern 46)
*   **Morris Traversal** (Pattern 48)
...
## 14. Backtracking
### 👶 The Concept (ELI5)
Imagine you are exploring a cave system. You go down a tunnel. If it's a dead end, you walk back ("backtrack") to the last intersection and try a different tunnel. You systematically try every path until you find the treasure or prove it's not there.
...
# ⚡ Advanced / High-Impact Patterns (GOOD TO KNOW)
...
# 🎁 All 50 Essential Patterns
> *Patterns critical for top-tier (L5+) interviews.*
...
### 👶 The Concept (ELI5)
Imagine sorting a pile of mail by Zip Code. You don't compare every letter to every other letter. You just toss them into bins: "100xx" bin, "200xx" bin. Then you just collect the piles. It’s strictly faster than comparing.

### 🧠 Deep Dive
*   **How it works**: Use the *value* of the element to determine its position.
    *   **Counting**: Count frequency of each value.
    *   **Bucket**: Scatter to buckets -> Sort buckets -> Gather.
